...
public class Reversal implements TransactionTypeSwitch, Constants {

    private final CheckFields checkFields;
    private final QueryHost queryHost;
    private final TransactionService transactionService;
    private final ReversalValidator reversalValidator;

    private final PinTranslationService pinTranslationService;
    int[] mandatoryFields = {2,3,4,7,11,12,13,22,32,37,41,42,43,90,95};
    ...
    public Context process(Context context) {
        ...
        if(checkFields.validateFields(req,mandatoryFields,optionalFields)
            ...
            String destination = reversalValidator.validateAndGetProcessor(context);
